...
- **29 registered games** in `Games/`, each a self-contained folder with an `index.html` entry point. See the [Game List](Game-List.md).
...
- [Game List](Game-List.md) — all 29 games with category, controls, and honest offline/remote status.
