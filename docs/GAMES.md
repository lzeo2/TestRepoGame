...
All **33 registered games** from `games.json` (ids 1–51 with gaps — the ids of removed games are not reused). Category comes from the catalog `cat` field; controls and status are based on the actual files in `Games/`.
