...
PD.UNITS = {
  ...
  char1:  shooter(1,  'Tabby Gunner',    'All-rounder',   { damage: 28, fireRate: 700,  bullet: 0, cost: 0 }),
  char2:  shooter(2,  'Calico Shot',     'Rapid chip',    { damage: 16, fireRate: 520,  bullet: 0, cost: 0 }),
  char6:  shooter(6,  'Sprint Kitten',   'Line piercer',  { damage: 12, fireRate: 400,  bullet: 2, pierce: 2, armorPierce: 1, bulletSpeed: 760, cost: 0 }),
  char11: shooter(11, 'Boomer Cat',      'Splash burst',  { damage: 46, fireRate: 1200, bullet: 1, splash: 80, bulletSpeed: 540, cost: 0 }),

  // --- Unlock tier 1 (clear stage 1) ---------------------------------------
  char7:  shooter(7,  'Flash Paw',       'Armor shredder',{ damage: 15, fireRate: 340,  bullet: 2, armorPierce: 5, bulletSpeed: 780, cost: 0 }),
  char12: shooter(12, 'Mortar Mane',     'Heavy splash',  { damage: 58, fireRate: 1550, bullet: 1, splash: 110, bulletSpeed: 500, cost: 0 }),

  // --- Unlock tier 2 (clear stage 2) ---------------------------------------
  char3:  shooter(3,  'Mittens Mk.II',   'Dual pierce',   { damage: 22, fireRate: 700,  bullet: 2, pierce: 2, cost: 0 }),
  char8:  shooter(8,  'Zippy',           'Swarm melter',  { damage: 9,  fireRate: 240,  bullet: 2, bulletSpeed: 800, cost: 0 }),
  char13: shooter(13, 'Heavy Tom',       'Sniper',        { damage: 95, fireRate: 1450, bullet: 0, armorPierce: 6, bulletSpeed: 720, cost: 0 }),

  // --- Unlock tier 3 (clear stage 3) ---------------------------------------
  char4:  shooter(4,  'Patch Ranger',    'Hybrid',        { damage: 27, fireRate: 820,  bullet: 1, splash: 50, cost: 0 }),
  char9:  shooter(9,  'Static Cat',      'Triple pierce', { damage: 14, fireRate: 470,  bullet: 2, pierce: 3, armorPierce: 2, cost: 0 }),
  char14: shooter(14, 'Big Bertha',      'Bombard',       { damage: 74, fireRate: 1650, bullet: 1, splash: 130, bulletSpeed: 480, cost: 0 }),

  // --- Unlock tier 4 (clear stage 4) ---------------------------------------
  char5:  shooter(5,  'Whisker Markscat','Marksman',      { damage: 42, fireRate: 900,  bullet: 0, armorPierce: 6, bulletSpeed: 700, cost: 0 }),
  char10: shooter(10, 'Needle Nine',     'Needle storm',  { damage: 12, fireRate: 300,  bullet: 2, pierce: 2, armorPierce: 3, bulletSpeed: 800, cost: 0 }),
  char15: shooter(15, 'Cannon Claws',    'Nuke',          { damage: 105, fireRate: 1750, bullet: 1, splash: 100, armorPierce: 4, bulletSpeed: 520, cost: 0 }),
  ...
  guardian: {
    ...
    hp: 620, damage: 0, cost: 0, scale: 0.6,
  ...
  boxing: {
    ...
    hp: 280, damage: 42, fireRate: 560, meleeRange: 130, armorPierce: 2, cost: 0, scale: 0.6,
...
/* HACKED variant: every cat unlocked from level 1. Fresh saves start with
 * the full roster; stage clears grant nothing further (nothing left to gate).
 * A one-shot save migration in index.html covers pre-existing saves that
 * share the base game's localStorage key. -------------------------------*/
PD.STARTER_UNLOCKS = ['char1', 'char2', 'char3', 'char4', 'char5', 'char6', 'char7', 'char8', 'char9', 'char10', 'char11', 'char12', 'char13', 'char14', 'char15', 'guardian', 'boxing'];
