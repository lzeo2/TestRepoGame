/*
 ...
 Modifications: p5.js vendored locally, keyPressed refactored into handleKey
 for touch controls, added tronStart/tronRestart hooks for the overlay buttons.
*/
var player1;
var player2;
var scl = 20;
...
/* shared by keyboard and the touch pads in index.html */
...
window.tronStart = function () {
    paused = 0;
};

window.tronRestart = function () {
    player1.reset();
    player2.reset();
    background(0);
    paused = 1;
