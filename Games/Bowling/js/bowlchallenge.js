...
function init() {
	...
	scoresDiv.style = "position: fixed; left: 50%; top: 0; transform: translate(-50%, 0); margin-top: 76px; white-space: pre; font-family: monospace; background: rgba(22, 32, 43, 0.85); color: #ffffff; padding: 4px 8px;";
