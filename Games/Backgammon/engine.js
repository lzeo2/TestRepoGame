/*
 * Backgammon rules engine + AI, ingested from
 * https://github.com/binarymax/backgammon.js
 * License: MIT (see LICENSE in this folder), Copyright (c) 2013 Max Irwin
 * Files: main.js (namespace), game.js (rules), brain.js (AI) concatenated
 * per file, verbatim except: the debug console.log('WINNER!...) line was
 * removed (repo rule: no console output in production paths).
 * The jQuery drag-drop board UI (board.js) and felt/piece images were NOT
 * taken: a new flat, dependency-free UI ships in script.js.
 */
