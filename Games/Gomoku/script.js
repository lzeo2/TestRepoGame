...
document.addEventListener('DOMContentLoaded', () => {
 ...
 const versionHistory = [
    ...
    function playSound(s) { if(!soundEnabled || !s) return; s.currentTime=0; s.play().catch(()=>{}); }
    ...
    soundToggle.addEventListener('click', ()=>{ soundEnabled=!soundEnabled; soundToggle.textContent = soundEnabled ? '声音开' : '声音关'; playSound(clickSound); });
